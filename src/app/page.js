...
const schema = z
  ...
  ).refine((x) => {return x.password === x.confirmPassword},{message: "Password does not match", path: ["confirmPassword"]});
...
export default function Home() {
  ...
  const computePrice = () => {
    ...
    return form.values.hasCoupon && form.values.coupon === "CMU2023" ? price *= 0.7 : price;
    //check discount here
  };
